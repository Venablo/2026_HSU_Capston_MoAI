...
export default function StudyRanking() {
        ...
        <div className="study-dashboard">
          ...
          <span className={`badge ${currentStudy.role}`}>
            ...
            <div className="menu-grid">
                <button onClick={() => navigate(`/study/${studyId}/dashboard`)}>대시보드</button>
                ...
                <button className="now-btn" onClick={() => navigate(`/study/${studyId}/ranking`)}>랭킹</button>
