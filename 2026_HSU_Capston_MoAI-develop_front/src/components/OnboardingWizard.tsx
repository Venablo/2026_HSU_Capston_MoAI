...
interface Props {
    onClose: () => void
    onCreated?: (result: CreateLearningRoomResponse) => void
    redirectOnSuccess?: boolean
}

// ── 컴포넌트 ──────────────────────────────────────────────────────────────────
export default function OnboardingWizard({ onClose, onCreated, redirectOnSuccess = true }: Props) {
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            if (redirectOnSuccess) navigate('/my-studies')
        } catch (err) {
